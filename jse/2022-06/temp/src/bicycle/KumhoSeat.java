...
extends Seat{
	   ...
	   public void setKeumhoSeat(Bicycle bicycle) {
			this.bicycle = bicycle;
			
			System.out.println("KumhoSeat::setKeumhoSeat(bicycle) invoked.");
		}//setBicycle

	   @Override
	   void getOn() {
		   System.out.println("KumhoSeat::getOn() invoked.");
	   ...
	   @Override
	   void getOff() {
		   System.out.println("KumhoSeat::getOff() invoked.");
	   ...
	   void hold (boolean locking) {
		   System.out.println("KumhoSeat::hold(locking) invoked.");
		...
		System.out.println("KumhoSeat::setBicycle(bicycle) invoked.");
	}

		@Override
	   void setting (int i) {
			System.out.println("KumhoSeat::setting (int i) invoked.");
			
			if(0 < i && i < 5) { // 1~4사이의 높이로 안장을 세팅
			   System.out.println("안장을 풉니다.");
			   this.hold = false;
			   
			   System.out.println("안장을 " + i + " 높이에 맞춥니다.");
			   this.Hight = i;
	   ...
	   void seatSetting(int height) {
			System.out.println("KumhoSeat::seatSetting(int height) invoked.");
			...
			if(180 <= height) {
			   ...
			   this.setting (2);
		   } else {this.setting (1);} //else - if
	   }
	   //seatSetting    
		   
		   void brocken() {
			   System.out.println("KumhoSeat::brocken() invoked.");
	   ...
	   public KumhoSeat(){}//기본 생성자
	   
	   
	   public KumhoSeat(int price) {
	      this(null, null, null, null, 0.0, price);
	      
	   }//가격 입력 생성자
	   
	   
	   public KumhoSeat(String brand,String model, String color, String material,double weight, int price) {
	      this(brand, model, color, material, weight, price, false);
	      
	   }//고유 속성 생성자
	   
	   
	   public KumhoSeat(boolean hold) {
	      this(null, null, null, null, 0.0, 0, hold);
	      
	   }//안장 on/off 생성자
	   
	   
	   public KumhoSeat(String brand,String model, String color, String material,

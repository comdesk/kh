...
//	=============================================================
	...
	//2. 생성자
	KumhoPedal() {
		System.out.println("KumhoPedal::default constructor() invoked.");
	} //기본 생성자

	KumhoPedal(String brand, String model, String color, String material,
			double weight, int price) {
		this(brand, model, color, material, weight, price, null, 0);
		
		System.out.println("KumhoPedal::constructor() invoked.");
	} //고유속성 필드에 대한 생성자
	
	KumhoPedal(int maxRotation) {
		this(null, maxRotation);
		
		System.out.println("KumhoPedal::constructor() invoked.");
	} //maxRotation 생성자
	
	KumhoPedal(String direction, int maxRotation) {
	...
	public void setBicycle(Bicycle bicycle) {
		System.out.println("KumhoPedal::setBicycle(bicycle) invoked.");
	...
	public void press(int cadence) {	//메소드 호출할 때 기어박스 클래스의 기어레벨 가져오고, 분당회전수 입력하기
		System.out.println("KumhoPedal::press(cadence) invoked.");
...
//					this.setSpeed(cadence); => 안 되네...
	...
	//2. 페달을 멈추는 메소드
		@Override
		public void stop() {
			System.out.println("KumhoPedal::stop() invoked.");

...
CREATE TABLE department5 (
    ...
    loc     VARCHAR2(15)    -- NULL 제약 조건을 가짐.
);
...
-- null 값 저장 허용
INSERT INTO department5 (deptno, dname, loc)
VALUES (30, NULL, '서울');      -- 부서는 만들었는데, 아직 이름을 못 정했을 때
...
-- null 값 저장 허용(하나만 null이어도 되고, 다 null이어도 된다.)
INSERT INTO department6 (deptno, dname, loc)
VALUES (40, null, '수원');

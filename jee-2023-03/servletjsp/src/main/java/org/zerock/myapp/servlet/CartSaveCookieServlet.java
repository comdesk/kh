...
public class CartSaveCookieServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse res) 
		...
		//Step.2 요청메시지의 헤더에 포함되어 있는, 모든 쿠키 획득
		Cookie[] cookies = req.getCookies();	//Cookie 타입의 객체를 원소로 하는 객체 배열 반환
		
		//Stpe.3 우리가 직접 브라우저로 보낼, 새로운 쿠키를 생성하자
		Cookie cookie = null;
		...
		//Step.5 응답메시지의 헤더에, 우리가 위 step.3에서 생성한 쿠키 객체를 저장
